...
Msg* MapDisplay::processRequest(Msg* request, [[maybe_unused]] CompiledDataManager& mger)
{
    ...
    std::string resp =
        ...
        "<style>"
        "html, body { margin: 1% 0;height: 99%;background-color: #B2B3C8 }"
        "#map {"
        "    height: 80%; width: 80%; margin: 0.5em  auto; padding: 0.5em;"
        ...
        "}"
        "#form {"
        "    width: 80%; margin: 0.5em auto; padding: 0.5em;"
        ...
        "var osm = L.tileLayer('/{z}/{x}/{y}.svg', {"
        "    attribution: 'Map data: &copy; <a href=\"http://www.openstreetmap.org/copyright\">OpenStreetMap</a>',"
        "    maxZoom: 19, tileSize:#tsz#, zoomOffset:#zofs#"
        "}); osm.addTo(map);#pin#"
        "var raster = L.tileLayer('/{z}/{x}/{y}.png', {"
        "    attribution: 'Map data: &copy; srtm', transparent:'true', opacity:0.3,"
        "    maxZoom: 19"
        "});"
        "var baseMap = {"
        "\"OpenStreetMap\": osm,"
