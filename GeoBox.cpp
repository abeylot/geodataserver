...
bool dividex(Rectangle r, Rectangle& left, Rectangle& right)
{
    ...
    else if(delta & UINT32_BIT30) mask_length = 31;
    else if(delta & UINT32_BIT29) mask_length = 30;
    else if(delta & UINT32_BIT28) mask_length = 29;
    else if(delta & UINT32_BIT27) mask_length = 28;
    else if(delta & UINT32_BIT26) mask_length = 27;
    else if(delta & UINT32_BIT25) mask_length = 26;
    else if(delta & UINT32_BIT24) mask_length = 25;
    else if(delta & UINT32_BIT23) mask_length = 24;
    else if(delta & UINT32_BIT22) mask_length = 23;
    else if(delta & UINT32_BIT21) mask_length = 22;
    else if(delta & UINT32_BIT20) mask_length = 21;
    else if(delta & UINT32_BIT19) mask_length = 20;
    else if(delta & UINT32_BIT18) mask_length = 19;
    else if(delta & UINT32_BIT17) mask_length = 18;
    else if(delta & UINT32_BIT16) mask_length = 17;
    else if(delta & UINT32_BIT15) mask_length = 16;
    else if(delta & UINT32_BIT14) mask_length = 15;
    else if(delta & UINT32_BIT13) mask_length = 14;
    else if(delta & UINT32_BIT12) mask_length = 13;
    else if(delta & UINT32_BIT11) mask_length = 12;
    else if(delta & UINT32_BIT10) mask_length = 11;
    else if(delta & UINT32_BIT9) mask_length = 10;
    else if(delta & UINT32_BIT8) mask_length = 9;
    else if(delta & UINT32_BIT7) mask_length = 8;
    else if(delta & UINT32_BIT6) mask_length = 7;
    else if(delta & UINT32_BIT5) mask_length = 6;
    else if(delta & UINT32_BIT4) mask_length = 5;
    else if(delta & UINT32_BIT3) mask_length = 4;
...
GeoBox makeGeoBox(Rectangle rect)
{
    ...
    else if(delta & UINT64_BIT62) mask_length = 63;
    else if(delta & UINT64_BIT61) mask_length = 62;
    else if(delta & UINT64_BIT60) mask_length = 61;
    else if(delta & UINT64_BIT59) mask_length = 60;
    else if(delta & UINT64_BIT58) mask_length = 59;
    else if(delta & UINT64_BIT57) mask_length = 58;
    else if(delta & UINT64_BIT56) mask_length = 57;
    else if(delta & UINT64_BIT55) mask_length = 56;
    else if(delta & UINT64_BIT54) mask_length = 55;
    else if(delta & UINT64_BIT53) mask_length = 54;
    else if(delta & UINT64_BIT52) mask_length = 53;
    else if(delta & UINT64_BIT51) mask_length = 52;
    else if(delta & UINT64_BIT50) mask_length = 51;
    else if(delta & UINT64_BIT49) mask_length = 50;
    else if(delta & UINT64_BIT48) mask_length = 49;
    else if(delta & UINT64_BIT47) mask_length = 48;
    else if(delta & UINT64_BIT46) mask_length = 47;
    else if(delta & UINT64_BIT45) mask_length = 46;
    else if(delta & UINT64_BIT44) mask_length = 45;
    else if(delta & UINT64_BIT43) mask_length = 44;
    else if(delta & UINT64_BIT42) mask_length = 43;
    else if(delta & UINT64_BIT41) mask_length = 42;
    else if(delta & UINT64_BIT40) mask_length = 41;
    else if(delta & UINT64_BIT39) mask_length = 40;
    else if(delta & UINT64_BIT38) mask_length = 39;
    else if(delta & UINT64_BIT37) mask_length = 38;
    else if(delta & UINT64_BIT36) mask_length = 37;
    else if(delta & UINT64_BIT35) mask_length = 36;
    else if(delta & UINT64_BIT34) mask_length = 35;
    else if(delta & UINT64_BIT33) mask_length = 34;
    else if(delta & UINT64_BIT32) mask_length = 33;
    else if(delta & UINT64_BIT31) mask_length = 32;
    else if(delta & UINT64_BIT30) mask_length = 31;
    else if(delta & UINT64_BIT29) mask_length = 30;
    else if(delta & UINT64_BIT28) mask_length = 29;
    else if(delta & UINT64_BIT27) mask_length = 28;
    else if(delta & UINT64_BIT26) mask_length = 27;
    else if(delta & UINT64_BIT25) mask_length = 26;
    else if(delta & UINT64_BIT24) mask_length = 25;
    else if(delta & UINT64_BIT23) mask_length = 24;
    else if(delta & UINT64_BIT22) mask_length = 23;
    else if(delta & UINT64_BIT21) mask_length = 22;
    else if(delta & UINT64_BIT20) mask_length = 21;
    else if(delta & UINT64_BIT19) mask_length = 20;
    else if(delta & UINT64_BIT18) mask_length = 19;
    else if(delta & UINT64_BIT17) mask_length = 18;
    else if(delta & UINT64_BIT16) mask_length = 17;
    else if(delta & UINT64_BIT15) mask_length = 16;
    else if(delta & UINT64_BIT14) mask_length = 15;
    else if(delta & UINT64_BIT13) mask_length = 14;
    else if(delta & UINT64_BIT12) mask_length = 13;
    else if(delta & UINT64_BIT11) mask_length = 12;
    else if(delta & UINT64_BIT10) mask_length = 11;
    else if(delta & UINT64_BIT9) mask_length = 10;
    else if(delta & UINT64_BIT8) mask_length = 9;
    else if(delta & UINT64_BIT7) mask_length = 8;
    else if(delta & UINT64_BIT6) mask_length = 7;
    else if(delta & UINT64_BIT5) mask_length = 6;
    else if(delta & UINT64_BIT4) mask_length = 5;
    else if(delta & UINT64_BIT3) mask_length = 4;
